...
public class AboutDialog {
	public static void showAboutDialog() {
		...
		creditsText.setText("This java program would not have been possible without the generous tutorials, help"
		...
		layout.setHorizontalGroup(layout
				...
				.addComponent(titleLabel).addComponent(versionLabel).addComponent(descLabel)
				.addComponent(authorLabel)
				.addComponent(creditLabel, GroupLayout.Alignment.LEADING)
				.addComponent(creditsText).addComponent(okButton));
		layout.setVerticalGroup(layout.createSequentialGroup()
				.addComponent(titleLabel).addComponent(versionLabel).addComponent(descLabel)
				.addComponent(authorLabel).addComponent(creditLabel).addComponent(creditsText)
				.addGap(20).addComponent(okButton));
